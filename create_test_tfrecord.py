...
flags.DEFINE_string('dataset_dir', "./mars_test/", 'String: Your dataset directory')
...
flags.DEFINE_string('tfrecord_filename', 'mars_test', 'String: The output filename to name your TFRecord file')
