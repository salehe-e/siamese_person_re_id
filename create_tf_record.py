# USAGE: python3 create_tf_record.py --tfrecord_filename=mars --dataset_dir=./mars/

import random
import tensorflow as tf
from dataset_utils import _dataset_exists, _get_filenames_and_classes, write_label_file, _convert_dataset, write_data_summary
import os
...
flags.DEFINE_string('tfrecord_filename', 'mars', 'String: The output filename to name your TFRecord file')
